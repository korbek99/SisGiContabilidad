...
Public Class ListaBanco
    ...
    Private Sub LlenarGrillalistar()
        GrdBanco.DataSource = Business.BFAfp.ListAllActive()
        GrdBanco.DataBind()
    End Sub
    ...
    End Sub
    Protected Sub GrdBanco_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GrdBanco.RowCommand
        ...
        If e.CommandName = "Editar" Then
            ...
            Dim gvRow As GridViewRow = GrdBanco.Rows(indice)
            ...
            Response.Redirect("AgregarBanco.aspx?id=" + valorfila)
        Else
