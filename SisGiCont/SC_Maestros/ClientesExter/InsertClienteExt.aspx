...
<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InsertClienteExt.aspx.vb" Inherits="SisGiCont.InsertClienteExt" %>
...
<div id="divDatos">
               ...
               <div style="font-weight:bold;" ><h3>Ingreso Clientes Externos</h3></div>	
                ...
                <table id="TblDatos" border="0">
                    ...
                    <tr>
                     ...
                     <tr>
                         ...
                         <td>:</td>
                         <td><asp:TextBox ID="Textsitio" runat="server" Width="248px"></asp:TextBox></td>
                         <td></td>
                         <td class="auto-style3"></td>
                         <td></td>
                         <td></td>
